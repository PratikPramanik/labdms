     ...
     <div id="body">
        <div id="col_main_left">
            <div id="user_assistance">
                ...
                <h3>
                    Actions</h3>
                <p> NOTICE: When activating forms, make sure it has 
                been reviewed by the proper administration.</p>
        ...
        <div id="col_main_right">
            <h2 class="section">
                ...
                <p>
                   ...
                   <p>Use the 
                       <asp:HyperLink ID="AdAdminLink" Runat="server" NavigateUrl="~/Admin/Ads.aspx">Form Administration page</asp:HyperLink> to see <em>deleted</em> ads<br />(select "Marked as Deleted" from the Status list).</p>
