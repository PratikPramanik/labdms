<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" CodeFile="Ads.aspx.cs"
    Inherits="Ads_aspx" Title="Forms and Features - Site Administration" %>
            ...
            <asp:Panel ID="ResultsPanel" Runat="server" Visible="False">
                <asp:GridView ID="AdsGrid" Runat="server" DataSourceID="AdsDataSource" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            ...
                            <HeaderStyle CssClass="col_checkbox" />
                            <ItemStyle CssClass="col_checkbox" />
                        </asp:TemplateField>
                        <asp:ImageField DataImageUrlFormatString="~/Images/preview-photo.gif" DataImageURLField="PreviewImageId"
                            HeaderText="Photo" SortExpression="PreviewImageId" AccessibleHeaderText="Form Photo" AlternateText="Icon indicating that there are photos for this ad.">
                ...
                <asp:Panel ID="AdActionsPanel" Runat="server">
                    ...
                    <asp:DropDownList ID="SelectedActionList" Runat="server">
                        <asp:ListItem Value="FeaturedLevel">Set Level: Featured Forms</asp:ListItem>
                        <asp:ListItem Value="NormalLevel">Set Level: Normal Forms</asp:ListItem>
