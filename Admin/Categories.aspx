        ...
        <div id="col_main_left">
            <div id="user_assistance">
                ...
                <p>
                    ...
                    <asp:Label ID="RemoveFailedLabel" Runat="server" Text='The Category could not be removed. Please make sure that there no Forms and no Sub-Categories within it. You can use the "Move" Feature below to clear the category first.'
            ...
            <div class="content_right">
                <fieldset>
                    ...
                    <asp:RadioButtonList ID="MoveAction" Runat="server" ValidationGroup="MoveCategory">
                        ...
                        <asp:ListItem Value="Ads">Move all Forms in this Category</asp:ListItem>
