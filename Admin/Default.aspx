        ...
        <div id="col_main_right">
            ...
            <div class="content_right">
                <asp:FormView ID="StatsFormView" Runat="server" DataSourceID="StatsDataSource">
                    <ItemTemplate>
                        <p>
                            <span style="text-decoration:underline">Forms</span><br />
                            # Active Forms:
                            ...
                            <br />
                            <strong><a href="Ads.aspx">Manage Forms &amp; Features</a></strong><br />
                            <br />
                            # Responses for currently active Forms:
                            ...
                            <br />
                            <strong><a href="Indexer.aspx">Index Database</a></strong><br />
                            <br />
                            Site Settings<br />
