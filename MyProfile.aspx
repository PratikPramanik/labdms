        ...
        <div id="col_main_left">
            <div id="user_assistance">
                ...
                <h3>
                    Actions</h3>
                <p>
                    <a href="MyAds.aspx">back to My Forms</a></p>
                <h3>
                    Help and Other Links</h3>
                <p>
                    You can modify your profile here. Please use your Santa Clara County email.</p>
            </div>
        </div>
            ...
            <div class="content_right">
                <fieldset>
                    ...
                    <asp:ChangePassword ID="ChangePasswordControl" Runat="server" 
                        ContinueButtonText="Return to My Forms" ContinueButtonType="Link" ContinueDestinationPageUrl="~/MyAds.aspx"
