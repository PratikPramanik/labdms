            ...
            <div id="search">
                <asp:Panel ID="SearchPanel" Runat="server" DefaultButton="SearchButton">
                    <fieldset>
                        ...
                        <asp:HyperLink ID="AdvancedSearchLink" Runat="server" NavigateUrl="~/SearchT2.aspx">[go to broad search]</asp:HyperLink>
                    </fieldset>
                </asp:Panel>
            </div>
            <div id="browse">
        ...
        <div id="content">
            <asp:Panel ID="ResultsPanel" Runat="server">
                <asp:GridView ID="AdsGrid" Runat="server" DataSourceID="AdSearchDataSource" AutoGenerateColumns="False"
                    ...
                    <EmptyDataTemplate>
                        No Forms were found matching your query; try a Broader Search.
                        <asp:HyperLink ID="BroadSearchLink" Runat="server" NavigateUrl="~/SearchT2.aspx">[go to broad search]</asp:HyperLink>
                    </EmptyDataTemplate>
                    <Columns>
                        <asp:BoundField HeaderText="Type" DataField="CategoryName" SortExpression="CategoryName">
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="URL" DataNavigateUrlFormatString="{0}"
                            HeaderText="FileURL" Text="Full Doc">
                            <ItemStyle CssClass="col_category" />
                            <HeaderStyle CssClass="col_category" />
                        </asp:HyperLinkField>
                    </Columns>
