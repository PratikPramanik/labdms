<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" CodeFile="MyAds.aspx.cs"
    Inherits="MyAds_aspx" Title="My Forms" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="Main" Runat="server">
    <div id="body">
        ...
        <div id="content_header">
            ...
            <ul>
                <li>
                <asp:LinkButton ID="CurrentAdsButton" Runat="server" OnClick="CurrentAdsButton_Click">Current Forms</asp:LinkButton></li><li>
                <asp:LinkButton ID="InactiveAdsButton" Runat="server" OnClick="InactiveAdsButton_Click">Inactive Forms</asp:LinkButton></li><li>
                <asp:LinkButton ID="SavedAdsButton" Runat="server" OnClick="SavedAdsButton_Click">Saved Bookmarks</asp:LinkButton></li><asp:PlaceHolder ID="ActivationAdsButtonPanel" Runat="server"><li>
                <asp:LinkButton ID="ActivationAdsButton" Runat="server" OnClick="ActivationAdsButton_Click">Forms waiting for activation</asp:LinkButton></li></asp:PlaceHolder>
                <li>
                <asp:HyperLink ID="ProfileLink" Runat="server" NavigateUrl="~/MyProfile.aspx">My Profile</asp:HyperLink></li></ul>
        </div>
        <div id="content">
            <asp:MultiView ID="MyAdsMultiView" Runat="server" ActiveViewIndex="0">
                <asp:View ID="UserAdsView" Runat="server">
                    ...
                    <asp:GridView ID="CurrentAdsGrid" Runat="server" DataSourceID="CurrentAds" AutoGenerateColumns="False"
                        ...
                        OnRowDataBound="CurrentAdsGrid_RowDataBound" BorderWidth="0px" CssClass="item_list"
                        ShowFooter="True">
                        <EmptyDataTemplate>
                            You have no currently active ads.
                            <asp:HyperLink ID="PostAdLink" Runat="server" NavigateUrl="~/PostAd.aspx">Click here to Post a new Form.</asp:HyperLink>
                        </EmptyDataTemplate>
                        <Columns>
                            <asp:ImageField DataImageUrlFormatString="~/Images/preview-photo.gif" DataImageUrlField="PreviewImageId"
                                SortExpression="PreviewImageId" 
                                AlternateText="Icon indicating that there are photos for this ad.">
                                <HeaderStyle CssClass="col_photo_nopreview" />
                                <ItemStyle CssClass="col_photo_nopreview" />
                            </asp:ImageField>
                            ...
                            <asp:BoundField HeaderText="Posted" DataField="DateCreated" SortExpression="DateCreated"
                                DataFormatString="{0:t} {0:M}, {0:yyyy}">
                            ...
                            <asp:BoundField HeaderText="Expires" DataField="ExpirationDate" SortExpression="ExpirationDate"
                                NullDisplayText="N/A" DataFormatString="{0:M},{0:yyyy}">
                                <HeaderStyle CssClass="col_general" />
                                <ItemStyle CssClass="col_general" />
                            </asp:BoundField>
                  ...
                  <asp:View ID="UserInactiveAdsView" Runat="server">
                    ...
                    <asp:PlaceHolder ID="ActivationAdsPanel" Runat="server"><h2 class="section">
                        My Forms waiting for Activation</h2>
